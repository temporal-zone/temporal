...
func GenesisStateWithValSet(app *App) GenesisState {
	...
	// update total supply
	sendEnabled := []banktypes.SendEnabled{{Denom: "utprl", Enabled: true}}

	bankGenesis := banktypes.NewGenesisState(banktypes.DefaultGenesisState().Params, balances, totalSupply, []banktypes.Metadata{}, sendEnabled)
