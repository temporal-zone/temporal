...
type UserInstructions struct {
	...
	UserInstruction []*UserInstruction `protobuf:"bytes,2,rep,name=userInstruction,proto3" json:"userInstruction,omitempty"`
}
...
func (m *UserInstructions) GetUserInstruction() []*UserInstruction {
	if m != nil {
...
var fileDescriptor_6be10c02216c948e = []byte{
	...
	0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x87, 0x29, 0xd4, 0x83, 0x28, 0x94, 0x52, 0x23, 0xa4, 0x13, 0xa2,
	0x51, 0xa9, 0x82, 0x4b, 0x20, 0xb4, 0x38, 0xb5, 0xc8, 0x13, 0xc9, 0x48, 0x21, 0x09, 0x2e, 0xf6,
	0xc4, 0x94, 0x94, 0xa2, 0xd4, 0xe2, 0x62, 0x09, 0x46, 0x05, 0x46, 0x0d, 0xce, 0x20, 0x18, 0x57,
	0xc8, 0x8b, 0x8b, 0xbf, 0x14, 0x55, 0xb5, 0x04, 0x93, 0x02, 0xb3, 0x06, 0xb7, 0x91, 0x82, 0x1e,
	0x9a, 0x03, 0xf4, 0xd0, 0x4c, 0x0d, 0x42, 0xd7, 0xe8, 0xe4, 0x75, 0xe2, 0x91, 0x1c, 0xe3, 0x85,
	...
	0xfa, 0x30, 0x63, 0x75, 0xab, 0xf2, 0xf3, 0x52, 0xe1, 0x3c, 0xfd, 0x0a, 0x98, 0xb7, 0x4a, 0x2a,
	0x0b, 0x52, 0x8b, 0x93, 0xd8, 0xc0, 0x9e, 0x31, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x29, 0x12,
	0xd2, 0x48, 0x30, 0x01, 0x00, 0x00,
}
...
func (m *UserInstructions) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UserInstruction) > 0 {
		for iNdEx := len(m.UserInstruction) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.UserInstruction[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
				i = encodeVarintUserInstructions(dAtA, i, uint64(size))
			}
			i--
			dAtA[i] = 0x12
		}
...
func (m *UserInstructions) Size() (n int) {
	...
	if len(m.UserInstruction) > 0 {
		for _, e := range m.UserInstruction {
			l = e.Size()
			n += 1 + l + sovUserInstructions(uint64(l))
		}
	}
...
func (m *UserInstructions) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.UserInstruction = append(m.UserInstruction, &UserInstruction{})
			if err := m.UserInstruction[len(m.UserInstruction)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
